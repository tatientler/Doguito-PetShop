export function valida(input){
    ...
    if(input.validity.valid){
        ...
        input.parentNode.querySelector('.input-mensagem-erro').innerHTML = mostraMensagemDeErro(tipoDeInput, input)
    }
}
...
const mensagensDeErro = {
    ...
    senha: {
        valueMissing: 'O campos de e-mail não pode estar vazio.',
